...
| `MaxSizeLimiter` | UI 레이아웃 컴포넌트 | `RectTransform`의 최대 너비와 높이를 축별로 제한 |
| `GameViewFullscreen`, `DevTool`, `PrefabCleanup` | 에디터 도구 | Game View 전체화면, 프로젝트별 개발 도구 기반, 프리팹 직렬화 문제 검사·정리 제공 |
...
- Unity `6000.3` 이상, Input System `1.19.0`, uGUI `2.0.0`을 사용합니다.
